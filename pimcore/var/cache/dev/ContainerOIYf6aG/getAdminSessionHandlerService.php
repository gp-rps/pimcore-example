...
class getAdminSessionHandlerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Pimcore\\Bundle\\AdminBundle\\Session\\Handler\\AdminSessionHandler'] = $instance = new \Pimcore\Bundle\AdminBundle\Session\Handler\AdminSessionHandler(($container->services['session'] ?? $container->load('getSessionService')), ($container->services['Pimcore\\Http\\RequestHelper'] ?? $container->getRequestHelperService()));
